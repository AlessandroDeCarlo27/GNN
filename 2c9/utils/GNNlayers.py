...
def model_definition_CYPmulti(NFEAT):
    ninput = tf.keras.Input((None, NFEAT))
    nminput1 = tf.keras.Input((None, None))
    nminput2 = tf.keras.Input((None, None))
    nminput3 = tf.keras.Input((None, None))
    ...
    y1 = tf.keras.layers.Dense(128)(x)
    y1 = tf.keras.layers.BatchNormalization()(y1)
    y1 = tf.keras.layers.LeakyReLU()(y1)
    y1 = tf.keras.layers.Dense(64)(y1)
    y1 = tf.keras.layers.BatchNormalization()(y1)
    y1 = tf.keras.layers.LeakyReLU()(y1)
    y1 = tf.keras.layers.Dense(32)(y1)
    y1 = tf.keras.layers.BatchNormalization()(y1)
    y1 = tf.keras.layers.LeakyReLU()(y1)
    y1 = tf.keras.layers.Dense(16)(y1)
    y1 = tf.keras.layers.BatchNormalization()(y1)
    y1 = tf.keras.layers.LeakyReLU()(y1)
    y1 = tf.keras.layers.Dense(1)(y1)
    ...
    y2 = tf.keras.layers.BatchNormalization()(y2)
    y2 = tf.keras.layers.LeakyReLU()(y2)
    y2 = tf.keras.layers.Dense(1)(y2)

    y3 = tf.keras.layers.Dense(128)(x)
    y3 = tf.keras.layers.BatchNormalization()(y3)
    y3 = tf.keras.layers.LeakyReLU()(y3)
    y3 = tf.keras.layers.Dense(64)(y3)
    y3 = tf.keras.layers.BatchNormalization()(y3)
    y3 = tf.keras.layers.LeakyReLU()(y3)
    y3 = tf.keras.layers.Dense(32)(y3)
    y3 = tf.keras.layers.BatchNormalization()(y3)
    y3 = tf.keras.layers.LeakyReLU()(y3)
    y3 = tf.keras.layers.Dense(16)(y3)
    y3 = tf.keras.layers.BatchNormalization()(y3)
    y3 = tf.keras.layers.LeakyReLU()(y3)
    y3 = tf.keras.layers.Dense(1)(y3)
...
def model_definition_LogPD(NFEAT):
    ninput = tf.keras.Input((None, NFEAT))
    nminput1 = tf.keras.Input((None, None))
    nminput2 = tf.keras.Input((None, None))
    nminput3 = tf.keras.Input((None, None))
...
def model_definition_LogPD2(NFEAT):
    ninput = tf.keras.Input((None, NFEAT))
    nminput1 = tf.keras.Input((None, None))
    nminput2 = tf.keras.Input((None, None))
    nminput3 = tf.keras.Input((None, None))
